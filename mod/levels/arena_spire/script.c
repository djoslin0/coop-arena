...
const LevelScript level_arena_spire_entry[] = {
	...
	AREA(1, arena_spire_area_1),
		...
		OBJECT(MODEL_NONE, 4800, 2309, 785, 0, 90, 0, (0x06 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 1600, 2309, 785, 0, -90, 0, (0x06 << 24), id_bhvArenaItem),
		...
		OBJECT(MODEL_NONE, 3200, 1909, -65, 0, -180, 0, (0x04 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 3200, 1909, 1635, 0, 0, 0, (0x04 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 3200, 2309, 785, 0, -180, 0, (0x02 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 3200, 1109, 785, 0, 0, 0, (0x02 << 24), id_bhvArenaItem),
