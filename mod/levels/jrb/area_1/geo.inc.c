...
const GeoLayout jrb_area_1_geo[] = {
	GEO_NODE_START(),
	GEO_OPEN_NODE(),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, jrb_dl_z_level_mesh_layer_1),
		GEO_DISPLAY_LIST(LAYER_TRANSPARENT, jrb_dl_z_lights_mesh_layer_5),
		GEO_DISPLAY_LIST(LAYER_OPAQUE, jrb_dl_z_lights_mesh_layer_1),
	GEO_CLOSE_NODE(),
	GEO_RETURN(),
};
