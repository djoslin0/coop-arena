...
#include "levels/arena_forts/header.h"

/* Fast64 begin persistent block [scripts] */
/* Fast64 end persistent block [scripts] */

const LevelScript level_arena_forts_entry[] = {
	INIT_LEVEL(),
	LOAD_MIO0(0x7, _arena_forts_segment_7SegmentRomStart, _arena_forts_segment_7SegmentRomEnd), 
	...
	AREA(1, arena_forts_area_1),
		...
		OBJECT(MODEL_NONE, -2890, 1900, 6370, 0, 90, 0, (0x04 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 2890, 1900, 6370, 0, -90, 0, (0x03 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 2890, 1900, -6380, 0, -90, 0, (0x04 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, -2890, 1900, -6380, 0, 90, 0, (0x03 << 24), id_bhvArenaItem),
		...
		OBJECT(MODEL_NONE, -2180, 420, -4770, 0, -90, 0, (0x01 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, 3314, 510, 6380, 0, -90, 0, (99), id_bhvArenaSpring),
		OBJECT(MODEL_NONE, -3314, 510, -6380, 0, 90, 0, (99), id_bhvArenaSpring),
		OBJECT(MODEL_NONE, 3314, 510, -6380, 0, -90, 0, (99), id_bhvArenaSpring),
		OBJECT(MODEL_NONE, -3314, 510, 6380, 0, 90, 0, (99), id_bhvArenaSpring),
		OBJECT(MODEL_NONE, 0, 4186, 0, 0, 0, 0, (10 << 16), bhvAirborneWarp),
		TERRAIN(arena_forts_area_1_collision),
		MACRO_OBJECTS(arena_forts_area_1_macro_objs),
