...
#include "levels/arena_origin/header.h"

/* Fast64 begin persistent block [scripts] */
/* Fast64 end persistent block [scripts] */

const LevelScript level_arena_origin_entry[] = {
	INIT_LEVEL(),
	LOAD_MIO0(0x7, _arena_origin_segment_7SegmentRomStart, _arena_origin_segment_7SegmentRomEnd), 
	...
	AREA(1, arena_origin_area_1),
		...
		TERRAIN(arena_origin_area_1_collision),
		MACRO_OBJECTS(arena_origin_area_1_macro_objs),
