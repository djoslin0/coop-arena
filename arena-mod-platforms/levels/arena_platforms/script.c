...
#include "levels/arena_platforms/header.h"

/* Fast64 begin persistent block [scripts] */
/* Fast64 end persistent block [scripts] */

const LevelScript level_arena_platforms_entry[] = {
	INIT_LEVEL(),
	LOAD_MIO0(0x7, _arena_platforms_segment_7SegmentRomStart, _arena_platforms_segment_7SegmentRomEnd), 
	...
	AREA(1, arena_platforms_area_1),
		...
		OBJECT(MODEL_NONE, 2700, 0, 0, 0, -90, 0, (0x02 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, 2000, 0, 2000, 0, -135, 0, (0x02 << 24), id_bhvArenaSpawn),
		...
		OBJECT(MODEL_NONE, 2000, 0, -2000, 0, -45, 0, (0x02 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, 2500, 0, -1100, 0, -67, 0, (0x02 << 24), id_bhvArenaSpawn),
		...
		OBJECT(MODEL_NONE, 1100, 0, 2500, 0, -157, 0, (0x02 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, 2500, 0, 1100, 0, -112, 0, (0x02 << 24), id_bhvArenaSpawn),
		...
		OBJECT(MODEL_NONE, 1100, 0, -2500, 0, -22, 0, (0x02 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, -3900, 650, 0, 0, 90, 0, (0x01 << 24), id_bhvArenaFlag),
		OBJECT(MODEL_NONE, 3900, 650, 0, 0, -90, 0, (0x02 << 24), id_bhvArenaFlag),
		OBJECT(MODEL_NONE, 3675, 265, -1350, 0, -90, 0, (0x06 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, 3675, 265, 1350, 0, -90, 0, (0x06 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, -3675, 265, -1350, 0, 90, 0, (0x06 << 24), id_bhvArenaItem),
		OBJECT(MODEL_NONE, -3675, 265, 1350, 0, 90, 0, (0x06 << 24), id_bhvArenaItem),
		...
		OBJECT(MODEL_NONE, 3900, 436, 0, 0, -90, 0, 0x00000000, id_bhvArenaKoth),
		OBJECT(MODEL_NONE, -3900, 436, 0, 0, 90, 0, 0x00000000, id_bhvArenaKoth),
		OBJECT(MODEL_NONE, 0, 145, 0, 0, -90, 0, 0x00000000, id_bhvArenaKoth),
		OBJECT(MODEL_NONE, 0, 3323, 0, 0, 0, 0, (10 << 16), bhvAirborneWarp),
		TERRAIN(arena_platforms_area_1_collision),
		MACRO_OBJECTS(arena_platforms_area_1_macro_objs),
