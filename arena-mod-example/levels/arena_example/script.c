...
const LevelScript level_arena_example_entry[] = {
	...
	AREA(1, arena_example_area_1),
		...
		OBJECT(MODEL_NONE, -3617, -155, -3380, 0, 0, 0, 12770, id_bhvArenaLadder),
		OBJECT(MODEL_NONE, 0, 0, -3000, 0, 0, 0, (0x01 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, 0, 0, 3100, 0, -180, 0, (0x02 << 24), id_bhvArenaSpawn),
		OBJECT(MODEL_NONE, -1534, -155, 3100, 0, 90, 0, (100 << 8) | (80), id_bhvArenaSpring),
		OBJECT(MODEL_NONE, -2900, -19, 3100, -20, -90, 0, (160 << 8) | (80), id_bhvArenaSpring),
